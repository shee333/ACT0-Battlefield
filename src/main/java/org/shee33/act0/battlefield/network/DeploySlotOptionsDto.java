 ...
 *
 * <p>{@code slotIndex} 与 Arcade {@code LoadoutSlot.hotbarIndex()} 一一对应（同时也是玩家
 * 快捷栏里该装备实际所在的格位），供 {@link DeploySlotOverridePacket} 回传覆盖选择、以及
 * {@code ArcadeLoadoutBridge#applyOverrides} 落地时直接定位背包格位使用。
 */
